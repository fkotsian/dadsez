export const CANIHAZ_API_BASE_URL = 'https://icanhazdadjoke.com'
export const CANIHAZ_API_SEARCH_URL = 'https://icanhazdadjoke.com/search?limit=20'
export const CANIHAZ_API_HEADERS = {
...
export const DADSEZ_API_VOTES_BASE = `${DADSEZ_API_BASE}/votes`


export const CANNOT_FETCH_VOTE_COUNT = '?'
